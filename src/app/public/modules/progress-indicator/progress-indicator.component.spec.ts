...
describe('Progress indicator component', function () {
  ...
  describe('Progress handler', function () {
    ...
    describe('Click handlers', () => {
      ...
      it('should call the action click handler on a nav button click', fakeAsync(() => {
        const component = handlerFixture.componentInstance;
        const actionClickSpy = spyOn(component, 'onFinishClick').and.callThrough();
      ...
      it('should not call the standard click handler on a nav button click', fakeAsync(() => {
        const component = handlerFixture.componentInstance;
        const standardClickSpy = spyOn(component, 'onStandardClick').and.callThrough();
      ...
      it('should not call the action click handler on a disabled nav button click', fakeAsync(() => {
        const component = handlerFixture.componentInstance;
        const actionClickSpy = spyOn(component, 'onFinishClick').and.callThrough();
        component.finishDisabled = true;
        handlerFixture.detectChanges();
        tick();
      ...
      it('should not call the standard click handler on a disabled nav button click', fakeAsync(() => {
        const component = handlerFixture.componentInstance;
        const standardClickSpy = spyOn(component, 'onStandardClick').and.callThrough();
        component.finishDisabled = true;
        handlerFixture.detectChanges();
